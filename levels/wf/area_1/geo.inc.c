...
const GeoLayout wf_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULL(-10000, 32000, -32000, 32000, -32000, 200, 0),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULL(-32000, -3100, -32000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_low_poly_4_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 391, 452, 4724),
		GEO_OPEN_NODE(),
			GEO_CULL(-10000, 32000, -32000, 32000, 1100, 32000, 0),
			GEO_OPEN_NODE(),
