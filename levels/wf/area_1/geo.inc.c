...
const GeoLayout wf_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, wf_dl_bWinterLevel_2020version_001_mesh_layer_2),
		GEO_CULL(-10000, 32000, -32000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, wf_dl_cWinterLevel_2020version_001_mesh_layer_2),
		GEO_CLOSE_NODE(),
		GEO_CULL(-10000, 32000, -32000, 32000, -1100, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, wf_dl_cWinterLevel_2020version_002_mesh_layer_2),
		GEO_CLOSE_NODE(),
		GEO_CULL(-10000, 32000, -32000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_cWinterLevel_2020version_006_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_CULL(-10000, 32000, -32000, 32000, -1100, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_cWinterLevel_2020version_013_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_CULL(-32000, -3500, -32000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE, wf_dl_dWinterLevel_2020version_001_mesh_layer_1),
		GEO_CLOSE_NODE(),
		GEO_CULL(-32000, -3500, -32000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_OPAQUE_DECAL, wf_dl_dWinterLevel_2020version_002_mesh_layer_2),
		GEO_CLOSE_NODE(),
		GEO_CULL(-10000, 32000, -32000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_DECAL, 391, 452, 4724, wf_dl_snowman_face_mesh_layer_6),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 491, 7486, 13961, wf_dl_WinterLevel_2020version_002_mesh_layer_1),
		GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULL(-32000, 32000, -32000, 32000, -32000, 500, 0),
		GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -6621, 742, 3279, 0, 135, 0, wf_dl_WinterLevel_2020version_011_mesh_layer_1),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 1051, 682, 6947),
		GEO_OPEN_NODE(),
			GEO_CULL(-10000, 32000, -32000, 32000, 1100, 32000, 0),
			GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 2830, 0, -9),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_FORCE, 2830, 0, -9, wf_dl_zzWinterLevel_2020version_013_mesh_layer_0),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_FORCE, 2830, 0, -9, wf_dl_zzWinterLevel_2020version_014_mesh_layer_0),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
