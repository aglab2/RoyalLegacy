...
void scroll_castle_grounds_dl_zsplash_mesh_layer_5_vtx_0() {
	int i = 0;
	int count = 12;
	int width = 64 * 0x20;
	...
	static int currentX = 0;
	int deltaX;
	Vtx *vertices = segmented_to_virtual(castle_grounds_dl_zsplash_mesh_layer_5_vtx_0);
...
void scroll_castle_grounds() {
	...
	scroll_castle_grounds_dl_zsplash_mesh_layer_5_vtx_0();
