...
const GeoLayout castle_grounds_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_grounds_dl_HubWorld_mesh_layer_5),
		GEO_CLOSE_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 1000, -32000, 32000, -2500, 32000, 0),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_HubWorld_014_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 2325, 3743, -5052, 90, 0, 0),
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 1000, -32000, 32000, -32000, -2500, 0),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, castle_grounds_dl_HubWorld_015_mesh_layer_1),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, 2325, 3743, -5052, 90, 0, 0, castle_grounds_dl_signs_mesh_layer_1),
		GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 2325, 3743, -5052, 90, 0, 0),
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 1000, -32000, 32000, -2500, 32000, 0),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_TRANSPARENT, castle_grounds_dl_zsplash_mesh_layer_5),
			GEO_CLOSE_NODE(),
		GEO_CLOSE_NODE(),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
