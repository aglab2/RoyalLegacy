void scroll_jrb_dl_Brimstone_Banks_Definitive_Edition_mesh_layer_1_vtx_35() {
	int i = 0;
	int count = 109;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	int deltaY;
	Vtx *vertices = segmented_to_virtual(jrb_dl_Brimstone_Banks_Definitive_Edition_mesh_layer_1_vtx_35);
...
void scroll_jrb() {
	scroll_jrb_dl_Brimstone_Banks_Definitive_Edition_mesh_layer_1_vtx_35();
