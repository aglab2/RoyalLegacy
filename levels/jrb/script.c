...
const LevelScript level_jrb_entry[] = {
	...
	AREA(1, jrb_area_1),
		...
		OBJECT(140, 8095, -265, 2931, 0, 96, 0, 0x0, bhvBlueCoinSwitch),
		...
		OBJECT(0, 7572, 2356, -8370, 0, 37, 0, 0x60000, bhvFadingWarp),
		...
		OBJECT(118, 8375, -291, 2209, 0, 5, 0, 0x0, bhvHiddenBlueCoin),
		OBJECT(118, 8086, -260, 2329, 0, 0, 0, 0x0, bhvHiddenBlueCoin),
