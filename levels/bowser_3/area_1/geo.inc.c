...
const GeoLayout bowser_3_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_ROTATION_NODE_WITH_DL(LAYER_TRANSPARENT, 90, 0, 0, bowser_3_dl_Bowser_Fight_001_mesh_layer_5),
		...
		GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 90, 0, 0, bowser_3_dl_skybox1_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bowser_3_dl_skybox2_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
