...
const GeoLayout bits_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -10342, 0, 12657, bits_dl_Bowser_Level_mesh_layer_1),
		GEO_OPEN_NODE(),
			GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bits_dl_Bowser_Level_mesh_layer_5),
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -10342, 0, 12657, 90, 0, 0, bits_dl_Bowser_Level_001_mesh_layer_1),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, -10342, 0, 12657, bits_dl_Bowser_Level_002_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_FORCE, bits_dl_Icosphere_mesh_layer_0),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bits_dl_Icosphere_001_mesh_layer_1),
