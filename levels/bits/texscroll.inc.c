...
void scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_22() {
	int i = 0;
	int count = 8;
	int width = 64 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(bits_dl_Bowser_Level_mesh_layer_1_vtx_22);
...
void scroll_bits_dl_Bowser_Level_003_mesh_layer_1_vtx_0() {
	int i = 0;
	int count = 91;
	int width = 64 * 0x20;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bits_dl_Bowser_Level_003_mesh_layer_1_vtx_0);
...
void scroll_bits_dl_Icosphere_001_mesh_layer_0_vtx_0() {
	int i = 0;
	int count = 11;
	int height = 64 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bits_dl_Icosphere_001_mesh_layer_0_vtx_0);
...
void scroll_bits() {
	...
	scroll_bits_dl_Icosphere_001_mesh_layer_0_vtx_0();
	scroll_bits_dl_Icosphere_002_mesh_layer_0_vtx_0();
	scroll_gfx_bits_dl_Bowser_Level_003_mesh_layer_1();
