...
void scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_13() {
	int i = 0;
	int count = 78;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bits_dl_Bowser_Level_mesh_layer_1_vtx_13);
...
void scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_26() {
	int i = 0;
	int count = 236;
	int width = 64 * 0x20;
	...
	int deltaX;
	Vtx *vertices = segmented_to_virtual(bits_dl_Bowser_Level_mesh_layer_1_vtx_26);
...
void scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_36() {
	int i = 0;
	int count = 130;
	int height = 32 * 0x20;
	...
	static int currentY = 0;
	int deltaY;
	Vtx *vertices = segmented_to_virtual(bits_dl_Bowser_Level_mesh_layer_1_vtx_36);
...
void scroll_bits() {
	...
	scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_13();
	scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_26();
	scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_27();
	scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_30();
	scroll_bits_dl_Bowser_Level_mesh_layer_1_vtx_36();
