...
const LevelScript level_sa_entry[] = {
	...
	AREA(1, sa_area_1),
		...
		OBJECT(0, 4216, 28, -6481, 0, 0, 180, 0xa0000, bhvSpinAirborneWarp),
		...
		OBJECT(0, 4170, 5, -5060, 0, -180, -20, 0, RM_Scroll_Texture),
		OBJECT(0, 4170, 5, -4653, 0, -180, -20, 1, RM_Scroll_Texture),
