...
const GeoLayout bob_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_CULL(-32000, 32000, 1000, 32000, -32000, 32000, 0),
		GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_OPAQUE, bob_dl_fgrass_001_mesh_layer_1),
		GEO_CULL(-32000, 32000, -32000, 2000, -4200, 32000, 0),
		GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_ALPHA, bob_dl_h_002_mesh_layer_4),
		...
		GEO_CULL(-32000, 0, -32000, 32000, -32000, -3000, 0),
		GEO_OPEN_NODE(),
		...
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, bob_dl_nzbg_mesh_layer_5),
