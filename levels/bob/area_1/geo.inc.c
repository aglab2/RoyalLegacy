...
const GeoLayout bob_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_CULL(-32000, 4364, -32000, 32000, -32000, 200, 0),
		GEO_OPEN_NODE(),
		...
		GEO_TRANSLATE_NODE(LAYER_OPAQUE, 938, 0, -3531),
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 32000, -32000, 32000, -32000, -1200, 0),
			GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_CULL(-32000, 0, -32000, 32000, -32000, 200, 0),
			GEO_OPEN_NODE(),
		...
		GEO_CULL(-32000, 32000, -32000, 2000, -32000, -2700, 0),
		GEO_OPEN_NODE(),
