...
#define SAVE_FILE_RL_GEM_0 SAVE_FLAG_HAVE_KEY_1
#define SAVE_FILE_RL_GEM_1 SAVE_FLAG_HAVE_KEY_2
#define SAVE_FILE_RL_GEM_2 SAVE_FLAG_UNLOCKED_BASEMENT_DOOR
#define SAVE_FILE_RL_GEM_3 SAVE_FLAG_UNLOCKED_UPSTAIRS_DOOR

#define SAVE_FILE_RL_GEMS (SAVE_FILE_RL_GEM_0 | SAVE_FILE_RL_GEM_1 | SAVE_FILE_RL_GEM_2 | SAVE_FILE_RL_GEM_3)
